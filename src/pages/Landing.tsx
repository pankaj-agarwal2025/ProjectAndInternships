...
const Landing = () => {
  ...
  <div
    ...
    style={{
      backgroundImage:
        'url("/lovable-uploads/2b5366a7-4406-492a-bb07-04dd88fe5ea0.png")',
  ...
  <div className="absolute inset-0 backdrop-blur-sm bg-gradient-to-b from-black/40 via-black/20 to-black/40 z-10"></div>
      ...
      <div className="container relative z-10 mx-auto px-4 py-20 min-h-[calc(100vh-80px)] flex flex-col items-center justify-center">
        ...
        >
          ...
          >
            A comprehensive portal for faculty members to efficiently track and
            manage student projects and internships.
          </motion.p>
